...
final class Version20240407183431 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE result_item_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE TABLE question_answer (id INT NOT NULL, question_id INT DEFAULT NULL, answer_id INT DEFAULT NULL, is_correct BOOLEAN NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE result (id INT NOT NULL, quiz_id INT DEFAULT NULL, account_id INT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE result ADD CONSTRAINT FK_136AC1139B6B5FBA FOREIGN KEY (account_id) REFERENCES account (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE result_item ADD CONSTRAINT FK_8F203E507A7B643 FOREIGN KEY (result_id) REFERENCES result (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE result_item ADD CONSTRAINT FK_8F203E50A3E60C9C FOREIGN KEY (question_answer_id) REFERENCES question_answer (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE result_item_id_seq CASCADE');
        ...
        $this->addSql('ALTER TABLE result DROP CONSTRAINT FK_136AC1139B6B5FBA');
        $this->addSql('ALTER TABLE result_item DROP CONSTRAINT FK_8F203E507A7B643');
        $this->addSql('ALTER TABLE result_item DROP CONSTRAINT FK_8F203E50A3E60C9C');
        ...
        $this->addSql('DROP TABLE result_item');
